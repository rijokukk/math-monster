...
export default {
  data() {
    return {
      ...
      turns: [],
      mode: "app-abilities",
      questionDifficult: 100,
      questionFeedback: "",
      currentAbility: "",
      ending: ""
    };
  },
  // Chooses correct ability if the answer for question was correct
  methods: {
    answered(isCorrect) {
      if (isCorrect) {
    ...
    whichAbility(abilityName) {
      ...
      switch (abilityName) {
        case "attack":
          this.questionDifficult = 20;
          this.mode = "app-question";
          break;
        case "special-attack":
          this.questionDifficult = 70;
          this.mode = "app-question";
          break;
        case "heal":
          this.questionDifficult = 40;
          this.mode = "app-question";
          break;
        case "give-up":
          this.giveUp();
