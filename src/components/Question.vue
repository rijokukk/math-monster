...
<script>
    ...
    export default{
        ...
        methods: {
            ...
            generateQuestion() {
                const firstNumber = this.generateRandomNumber(1, this.questionDifficult);
                const secondNumber = this.generateRandomNumber(1, this.questionDifficult);
            ...
            // Generates random number for the math problem
